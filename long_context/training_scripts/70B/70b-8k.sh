...
#SBATCH --exclude=nid006539,nid007378,nid006931,nid005338
...
DATASETS="/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-70B/data-mixture/8192"
...
GBS=2048 # Global batch size # NOTE(tj.solergibert) Originally this was 2048 BUT we doubled nodecount + GBS. Swicth to rampup batch size feature
SEQ_LEN=8192 # Sequence length
TRAINING_STEPS=4800  # total tokens = 1_075_000 * 8_388_608 = 9_017_753_600_000
...
EXP_NAME=apertus3-70b-8k-512nodes
PROJECT_DIR=/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-70B-runs/Meg_Runs/$PROJECT_NAME

#########################################
LOAD_DIR=/capstor/scratch/cscs/asolergi/main_run_70B_megatron/Megatron-LM/logs/Meg-Runs/main-runs-v1/apertus3-70b-512-nodes-1e-5lr/checkpoints-512-noOverlap
