...
#SBATCH --job-name=70b-64k
#SBATCH --output=/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-70B-runs/slurm_logs/%x-%j.out
#SBATCH --error=/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-70B-runs/slurm_logs/%x-%j.err
...
#SBATCH --exclude=nid006539,nid007378,nid006931,nid006726,nid006521,nid006806
...
DATASETS="/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-70B/data-mixture/65536_30b_swiss"
...
GBS=256 # Global batch size # NOTE(tj.solergibert) Originally this was 2048 BUT we doubled nodecount + GBS. Swicth to rampup batch size feature
SEQ_LEN=65536 # Sequence length
TRAINING_STEPS=1742  # total tokens = 1_075_000 * 8_388_608 = 9_017_753_600_000
CHECKPOINT_STEPS=50 # testing checkpointing
...
EXP_NAME=apertus3-70b-64k-512nodes
PROJECT_DIR=/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-70B-runs/Meg_Runs/$PROJECT_NAME

#########################################
LOAD_DIR=/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-70B-runs/Meg_Runs/main-long-ctx-runs-70b-v1/apertus3-70b-32k-512nodes/checkpoints
