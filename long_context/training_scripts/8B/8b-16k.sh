...
TRAINING_STEPS=6930  # total tokens = 1_075_000 * 8_388_608 = 9_017_753_600_000
CHECKPOINT_STEPS=500 # testing checkpointing
...
EXP_NAME=apertus3-8b-16k-$SLURM_NNODES-nodes-2M
PROJECT_DIR=/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-8B-runs/Meg_Runs/$PROJECT_NAME

#########################################
LOAD_DIR=/capstor/store/cscs/swissai/infra01/users/ctianche/long-ctx-8B-runs/Meg_Runs/main-long-ctx-runs-8b-v1/apertus3-8b-8k-256-nodes-1M/checkpoints
