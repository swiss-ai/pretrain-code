...
#SBATCH --job-name=apertus-1p5-70b-sft-256k
...
TOKENIZER_MODEL=CHANGE_THIS  # Apertus 1.5 tokenizer with tool-output and thinking tokens (Apertus-v1p5-tool_output_toks-think_toks).
...
EXCLUDED_PREFIXES=(
	$VISION_DATAROOT/16K_128k/molmopoint_guisyn
)
...
EXP_NAME=apertus-1p5-70b-sft-256k
