...
# Phase 5 (cooldown).
# Iterations 989'500 to 1'062'328.
# Remember to change seed of ALL datasets via the `--seed` argument.
# DATASETS=(
...
GBS=4096 # Global batch size # NOTE(tj.solergibert) Originally this was 2048 BUT we doubled nodecount + GBS. Swicth to rampup batch size feature
SEQ_LEN=4096 # Sequence length
COOLDOWN_SAMPLES=403905806  # 98609 training iterations, 1654B tokens.
...
EXP_NAME=apertus3-70b-$SLURM_NNODES-nodes-1e-5lr-phase-5
...
TRAINING_ARGS=(
	...
	--rampup-batch-size 2048 2048 1072164864 # Double the batchsize from 2048->4096 at ~4392B tokens in.
