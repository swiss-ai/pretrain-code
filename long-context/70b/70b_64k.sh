...
#SBATCH --job-name=apertus-1p5-70b-64k
...
DATAROOT=CHANGE_THIS  # 64k long-context data mixture.
LOAD_CKPT_DIR=CHANGE_THIS  # Checkpoint to start from: output of 70b_32k.sh.
...
SEQ_LEN=65536  # Sequence length.
CHECKPOINT_STEPS=125
TRAINING_STEPS=3500  # ~58.7B tokens.
