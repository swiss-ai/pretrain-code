...
#SBATCH --job-name=apertus-1p5-70b-256k
...
DATAROOT=CHANGE_THIS  # 256k long-context data mixture.
LOAD_CKPT_DIR=CHANGE_THIS  # Checkpoint to start from: output of 70b_128k.sh.
...
CHECKPOINT_STEPS=50
TRAINING_STEPS=3000  # ~50.3B tokens.
