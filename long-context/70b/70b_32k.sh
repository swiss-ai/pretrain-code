...
#SBATCH --job-name=apertus-1p5-70b-32k
...
DATAROOT=CHANGE_THIS  # 32k long-context data mixture.
LOAD_CKPT_DIR=CHANGE_THIS  # Checkpoint to start from: output of ../../pre-training/apertus-1p5-70b-stage3.sh.
...
CONTAINER_ENV=CHANGE_THIS  # Container environment file: ../../container/apertus-2-alps4-dev.toml.
...
PRETRAIN_DATASETS=(
	...
	$DATAROOT/cooldown_subsample/text_stage_3/finemath-3plus-merge
	$DATAROOT/cooldown_subsample/text_stage_3/finepdfs-edu-multilingual-preprocessed_first_half_CPT
	$DATAROOT/cooldown_subsample/text_stage_3/finepdfs-edu-multilingual-preprocessed_second_half_longcontext
	$DATAROOT/cooldown_subsample/text_stage_3/finepdfs-edu-preprocessed-first_half_CPT
	$DATAROOT/cooldown_subsample/text_stage_3/finepdfs-edu-preprocessed-second_half_longcontext
	$DATAROOT/cooldown_subsample/text_stage_3/finetranslations-first_half_CPT
	$DATAROOT/cooldown_subsample/text_stage_3/finetranslations-second_half_longcontext
	$DATAROOT/cooldown_subsample/text_stage_3/infiwebmath-3plus-fine-merge
	$DATAROOT/cooldown_subsample/text_stage_3/Nemotron-CC-v2.1-preprocessed
	$DATAROOT/cooldown_subsample/text_stage_3/original  # Code: stackv2-edu, Nemotron-Pretraining-Code-v1-Synthetic and opencoder.
	$DATAROOT/cooldown_subsample/text_stage_3/swissai-dclm-edu-filterrobots_fine-merge
	$DATAROOT/cooldown_subsample/text_stage_3/swissai-fineweb-2_0_1-quality_10-filterrobots-first_half_CPT
	$DATAROOT/cooldown_subsample/text_stage_3/swissai-megamath-web-pro-filterrobots-merge
	$DATAROOT/cooldown_subsample/text_stage_3/swiss-caselaw-preprocessed
	# Cooldown subsample: vision.
	$DATAROOT/cooldown_subsample/70B
	# Cooldown subsample: audio.
	$DATAROOT/cooldown_subsample/Apertus1p5_cooldown_tokenized
	# Long-context samples: long documents, images and audio.
	$DATAROOT/long_context_samples/raw/second_half_length_filter/Audio
	$DATAROOT/long_context_samples/raw/second_half_length_filter/Biomed-Enriched_preprocessed
	...
	$DATAROOT/long_context_samples/raw/second_half_length_filter/Image-extra
...
SFT_DATASETS=(
	...
	$DATAROOT/cooldown_subsample/text_stage_3/apertus_sft_filtered
...
# Known problematic token files, excluded from the blend.
EXCLUDED_PREFIXES=(
	$DATAROOT/cooldown_subsample/text_stage_3/swiss-caselaw-preprocessed/dump-1_00014_tokens
	$DATAROOT/cooldown_subsample/text_stage_3/swiss-caselaw-preprocessed/dump-2_00015_tokens
	$DATAROOT/cooldown_subsample/text_stage_3/swiss-caselaw-preprocessed/dump-3_00017_tokens
	$DATAROOT/cooldown_subsample/text_stage_3/swiss-caselaw-preprocessed/dump-4_00015_tokens
)
...
TARGET_TOKENS=60000000000  # ~60B tokens.
CHECKPOINT_STEPS=125
...
PROJECT_NAME=main-runs-apertus-1p5-70b-long-context
EXP_NAME=apertus-1p5-70b-32k
...
LEARNING_RATE_ARGS=(
	--lr 0.000002
	--min-lr 0.0000002  # x10 reduction
