...
#SBATCH --job-name=apertus-1p5-8b-256k
...
LOAD_CKPT_DIR=CHANGE_THIS  # Checkpoint to start from: output of 8b_128k.sh.
...
PRETRAIN_DATASETS=(
	...
	$DATAROOT/extra_vision_samples  # Image-text pairs (ChartNet code and summaries, MINT-1T arXiv, NASA, WAFFLE) and interleaved OWID articles.
